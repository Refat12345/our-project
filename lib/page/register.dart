...
class Register extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    double heightScreen = MediaQuery
        ...
        .size
        .height;
    BoxConstraints height = const BoxConstraints();
                                    ...
                                    child: PinCode(
                                      onTap: () {
                                        if (pinController.text.length < 4) {
                                          flutterToast(
                                              "من فضلك قم بتعبئة كامل الحقول",
                                              "error", height.maxHeight,"pin");
                                        } else {
                                         if(CacheHelper.getData(key: 'type') ==
                                             "customer")
                                         {
                                           flutterToast("تم إنشاء الحساب بنجاح", "type", height.maxHeight,"notPin");
                                           Navigator.push(context, MaterialPageRoute(builder: (context)=>Login()));
                                         }else
                                         {

                                           flutterToast("طلبك قيد المعالجة", "type", height.maxHeight,"notPin");
                                           Navigator.push(context, MaterialPageRoute(builder: (context)=>Login()));
                                         }
                                        }
                                      },
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                                ...
                                child: Padding(
                                  ...
                                  child: DropdownButtonFormField(
                                      ...
                                      iconSize: constrain.maxHeight > 1300
                                          ...
                                          : constrain.maxHeight >= 950 &&
                                          constrain.maxHeight <= 1000
                                          ? constrain.maxHeight * 0.09
                                          : constrain.maxHeight * 0.042),
                                      ...
                                      onChanged: (value) {
                                        if (value == "1") {
                                          RegisterCubit
                                              .get(context)
                                              .values = 1;
                                          RegisterCubit.get(context).removeField();
                                        } else {
                                          RegisterCubit
                                              .get(context)
                                              .values = -1;
                            ...
                            RegisterCubit.get(context).values==1?const SizedBox(): Text(
                              "اسم المستخدم",
                              style: TextStyle(
                                  fontSize: fontSize,
                                  color: grey,
                            ...
                            RegisterCubit.get(context).values==1?const SizedBox(): SizedBox(
                              height: constrain.maxHeight / 73,
                            ),
                            RegisterCubit.get(context).values==1?const SizedBox():Filed(
                                formKey: nameFormKey,
                                onChange: (value) {
