    ...
    return BlocProvider(
      ...
      child: BlocConsumer<EditstoreeCubit, EditstoreeState>(
        ...
        builder: (context, state) {
          getshopinfomodel? Getshopmodel = EditstoreeCubit.get(context).Getshopinfomodel;

          File ?image=EditstoreeCubit.get(context).addImage;
          final _nametextcontroller = TextEditingController();
          _nametextcontroller.text = Getshopmodel?.shopData?.name ??'';
          final _descriptiontextcontroller = TextEditingController();
          _descriptiontextcontroller.text = Getshopmodel?.shopData?.description ??'';
          final _phonenumbercontroller = TextEditingController();
          _phonenumbercontroller.text = Getshopmodel?.shopData?.phoneNumber ??'';
                    ...
                    child: Column(
                      ...
                      children: [
                        InkWell(
                            ...
                            child: Image(
                                image: image ==null ?
                                 NetworkImage(imageShopUrl + (Getshopmodel?.shopData?.photo ?? 'sd'),) : FileImage(image) as ImageProvider<Object>,
                                fit: BoxFit.contain,
