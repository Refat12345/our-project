...
class Cart extends StatelessWidget {
  ...
  Widget getBottom(
      width, height, BuildContext context, CartModel cartModel) {
    return Container(
      height: height > 1000
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              textDirection: TextDirection.rtl,
              children: [
                CacheHelper.getData(key: 'bool')==false?ConfirmCartWithDifferentLocation('bool'):ZoomTapAnimation(
                  onTap: cartModel.cartItems!.length == 0
                      ? null
                      : () {
                    showDialog(
                        context: context,
