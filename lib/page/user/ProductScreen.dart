...
import 'package:project2/page/user/searchproduct.dart';
...
class ProductScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
  create: (context) => GetproductCubitt()..getproductcategory(id: 2)..getcategoryy(),
  ...
  builder: (context, state) {
    getproductbycategorymodel? getproductcategormodel  = GetproductCubitt.get(context).getProductModel ;
    Categorymodel? getcategorymodel  = GetproductCubitt.get(context).getCategorymodel ;
    return LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          ...
          return ((getproductcategormodel !=null)&&(getcategorymodel != null))?Container(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemCount: getcategorymodel?.categories?.length ??0,
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  getcategorymodel?.categories![index].name??'ds',
                  ...
                  Expanded(
                    child: GridView.builder(
                        ...
                        itemCount: getproductcategormodel?.productsData?.length ??0,
                          ...
                          return InkWell(
                            onTap: (){
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => ProductDetails(id: getproductcategormodel?.productsData![index].id??1,)));
                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            Text(
                                              getproductcategormodel?.productsData![index].name??'ds',
                                              style: TextStyle(
                                  ...
                                  child: Visibility(
                                    ...
                                    child: IconButton(
                                      icon: CircleAvatar(
                                        ...
                                        backgroundColor: GetproductCubitt.get(context).favourites[getproductcategormodel!.productsData?[index].id] == 1
                                            ? Colors.red
                                            : Colors.grey,
                                        child: Icon(
                                          Icons.favorite,
                                      ...
                                      onPressed: () {
                                        GetproductCubitt.get(context).changefavourite(
                                          id: getproductcategormodel!.productsData?[index].id,
                                        );
                                      },
                                    ),
                                  ),
