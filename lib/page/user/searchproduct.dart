                                      ...
                                      return InkWell(
                                        onTap: (){
                                          Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                  builder: (context) => ProductDetails(id: Searchproductmodel?.productsData![index].id??1,)));
                                        },
                                        child: Stack(
                                          children: [
                                            Card(
                                              ...
                                              child: Visibility(
                                                ...
                                                child: IconButton(
                                                  icon: CircleAvatar(
                                                    ...
                                                    backgroundColor: SearchstoreCubit.get(context).favourites[Searchproductmodel!.productsData?[index].id] == 1
                                                        ? Colors.red
                                                        : Colors.grey,
                                                    child: Icon(
                                                      Icons.favorite,
                                                  ...
                                                  onPressed: () {
                                                    SearchstoreCubit.get(context).changefavourite(
                                                      id: Searchproductmodel!.productsData?[index].id,
                                                    );
                                                  },
                                                ),
                                              ),
