...
String type;
  ...
  Widget build(BuildContext context) {
    ...
    return  BlocProvider(
      ...
      child: BlocConsumer<ConfirmCartWithDifferentLocationCubit,ConfirmCartWithDifferentLocationState>
        (
        ...
        {
          ConfirmCartWithDifferentLocationCubit confirm=ConfirmCartWithDifferentLocationCubit.get(context);
          return  BlocProvider(
              ...
              child: BlocConsumer<AddLocationCubit,AddLocationState>
                ...
                builder: (context,state)
                {
                  AddLocationCubit addLocationCubit =AddLocationCubit.get(context);
                  return ConditionalBuilder(
                      ...
                      fallback: (context)=>const Center(child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(green),),));
                },
              )
          );
        },
